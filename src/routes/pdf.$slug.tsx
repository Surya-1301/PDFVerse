    ...
    <section className="relative min-h-screen overflow-hidden bg-bg-base">
      ...
      <Container className="relative py-12 sm:py-16">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl" style={{ color: 'var(--text-1)' }}>
            {title}
          </h1>

          <p className="mx-auto mt-4 max-w-3xl text-base leading-7 sm:text-lg" style={{ color: 'var(--text-2)' }}>
            {description}
          </p>
        </div>
            ...
            <div className="overflow-hidden rounded-[2rem] border shadow-2xl" style={{ borderColor: 'var(--border)', background: 'color-mix(in srgb, var(--surface) 60%, transparent)' }}>
              ...
              <div className="flex flex-col items-center px-5 py-10 sm:px-8">
                ...
                <button
                  ...
                  style={{ background: 'var(--accent)', color: 'var(--primary-foreground)', boxShadow: '0 4px 14px 0 var(--accent-glow)' }}
                >
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl" style={{ background: 'color-mix(in srgb, var(--primary-foreground) 15%, transparent)' }}>
                ...
                <button
                  ...
                  className="mt-5 inline-flex items-center gap-2 text-base font-medium transition hover:text-white"
