    ...
    <section className="relative min-h-screen overflow-hidden bg-bg-base">
      ...
      <Container className="relative py-12 sm:py-16">
        ...
        <a
          ...
          className="home-chat-btn fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-xl transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 sm:bottom-6 sm:right-6"
        >
          <MessageCircle
            className="h-6 w-6"
            aria-hidden="true"
