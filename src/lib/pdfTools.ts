...
export const pdfTools: PdfTool[] = [
  ...
  { title: "OCR PDF", description: "Turn scanned PDFs into searchable PDFs and extract text with OCR.", slug: "ocr", category: "organize", icon: ScanText },
  { title: "Chat with PDF", description: "Ask questions, summarize, and explore a PDF with AI.", slug: "chat-with-pdf", category: "edit", icon: FileSearch },
  ...
  { title: "Word to PDF", description: "Convert DOC or DOCX files into PDF while preserving layout, tables, images, fonts, and page breaks.", slug: "word-to-pdf", category: "convertToPdf", icon: FileText },
  { title: "PowerPoint to PDF", description: "Convert PPT or PPTX slides into PDF pages while preserving themes, images, charts, and slide layout.", slug: "powerpoint-to-pdf", category: "convertToPdf", icon: FileText },
  { title: "Excel to PDF", description: "Convert Excel into print-ready PDFs with sheet layout and page sizing optimized automatically.", slug: "excel-to-pdf", category: "convertToPdf", icon: FileText },
  ...
  { title: "PDF to JPG", description: "Convert PDF pages into high-quality JPG images, with efficient ZIP download for multi-page files.", slug: "pdf-to-jpg", category: "convertFromPdf", icon: FileImage },
  ...
  { title: "PDF to PowerPoint", description: "Convert PDF pages into a PowerPoint presentation using server-side rendering.", slug: "pdf-to-powerpoint", category: "convertFromPdf", icon: FileText },
