import { C as FileSearch, M as Combine, S as FileText, T as FileImage, a as Trash2, d as RotateCw, f as Plus, g as LockKeyhole, j as Crop, l as Scissors, o as Stamp, s as ShieldCheck, v as Image, y as Hash } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pdfTools-BytLHzMV.js
var categoryTabs = [
	{
		id: "all",
		label: "ALL"
...
var pdfTools = [
	{
		title: "PDF Editor",
		description: "Edit existing PDF text, add text and images, annotate, sign, and download your edited PDF.",
		slug: "pdf-editor",
		category: "edit",
		icon: FileText
	},
...
//#endregion
export { slugAliases as i, findTool as n, pdfTools as r, categoryTabs as t };
